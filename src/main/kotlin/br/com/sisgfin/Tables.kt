...
object Employees : Table("employees") {
    ...
    val bankCode       = varchar("bank_code", 3).nullable()
    val agencyNumber   = varchar("agency_number", 10).nullable()
    val agencyDv       = varchar("agency_dv", 2).nullable()
    val accountNumber  = varchar("account_number", 20).nullable()
    val accountDv      = varchar("account_dv", 2).nullable()
    val accountType    = varchar("account_type", 2).nullable().default("CS")
